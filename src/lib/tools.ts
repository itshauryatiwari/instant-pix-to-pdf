...
export const TOOLS: Tool[] = [
  ...
  { slug: "pdf-to-image", title: "PDF to Image", description: "Export every page of a PDF as a high-quality image.", icon: ImageIcon },
  { slug: "merge-pdf", title: "Merge PDF", description: "Combine several PDFs into one document in seconds.", icon: Combine },
  { slug: "split-pdf", title: "Split PDF", description: "Split a PDF into individual pages or custom ranges.", icon: Scissors },
  { slug: "compress-pdf", title: "Compress PDF", description: "Reduce PDF file size while keeping quality intact.", icon: Minimize2 },
  { slug: "rotate-pdf", title: "Rotate PDF", description: "Rotate one or all pages of a PDF document.", icon: RotateCw },
